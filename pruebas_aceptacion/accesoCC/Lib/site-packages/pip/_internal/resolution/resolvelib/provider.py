...
class PipProvider(_ProviderBase):
    ...
    def identify(
            self, requirement_or_candidate: Union[Requirement, Candidate]) -> str:
    ...
    def get_preference(
        ...
        * If equal, order alphabetically for consistency (helps debuggability).
        """
        lookups = (r.get_candidate_lookup()
    ...
    def get_dependencies(self, candidate: Candidate) -> Sequence[Requirement]:
        ...
        return [r for r in candidate.iter_dependencies(
            with_requires) if r is not None]
