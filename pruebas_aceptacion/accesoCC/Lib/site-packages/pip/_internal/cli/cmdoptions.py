...
def make_option_group(group: Dict[str, Any],
                      parser: ConfigOptionParser) -> OptionGroup:
    """
...
def check_dist_restriction(
        options: Values, check_target: bool = False) -> None:
...
def _handle_src(option: Option, opt_str: str, value: str,
...
def _convert_python_version(
        value: str) -> Tuple[Tuple[int, ...], Optional[str]]:
    """
